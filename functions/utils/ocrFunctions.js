...
/* 
// för test av funktionen i firebase emulators:start


function ocrImage(fileName) {
    return "Walmart>Save money. live better. (712) 366-3326manager donald moneymaker3201 manawa centre drcouncil"
}

function ocrPdf(fileName) {
    return "Walmart>Save money. live better. (712) 366-3326manager donald moneymaker3201 manawa centre drcouncil"
}
function getTextFromJson(object) {
    console.log("JSON ocr Processed");
}
